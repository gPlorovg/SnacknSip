...
DATABASES = {
    "default": {
        ...
        "NAME": config("DB_NAME", default="snacknsip"),
        "USER": config("DB_USER", default="snacknsip"),
        "PASSWORD": config("DB_PASSWORD", default="snacknsip"),
...
REST_FRAMEWORK = {
    "DEFAULT_AUTHENTICATION_CLASSES": [
        "apps.api.auth.backends.EventUserJWTAuthentication",
    ],
...
# App settings
# =============================================================================
BOT_SECRET_TOKEN = config("BOT_SECRET_TOKEN", default="")
